...
class PersonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.PersonTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\Person';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.Person';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\Person');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\Person) { // it's a model object
