...
abstract class Deposit implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\Map\\DepositTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\Base\Deposit object.
     * @see applyDefaults()
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\Deposit The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\Deposit (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\Deposit Clone of current object.
     * @throws PropelException
     */
