...
abstract class VolunteerOpportunity implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\Map\\VolunteerOpportunityTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\Base\VolunteerOpportunity object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ChurchCRM\VolunteerOpportunity The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\VolunteerOpportunity'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ChurchCRM\VolunteerOpportunity
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\VolunteerOpportunity The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\VolunteerOpportunity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\VolunteerOpportunity Clone of current object.
     * @throws PropelException
     */
