...
abstract class Person2group2roleP2g2r implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\Map\\Person2group2roleP2g2rTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\Base\Person2group2roleP2g2r object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|Person2group2roleP2g2r The current object, for fluid interface
     */
     ...
     * @return $this|\ChurchCRM\Person2group2roleP2g2r The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Person2group2roleP2g2rTableMap::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->p2g2r_per_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Person2group2roleP2g2rTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->p2g2r_grp_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : Person2group2roleP2g2rTableMap::translateFieldName('RoleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->p2g2r_rle_id = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = Person2group2roleP2g2rTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\Person2group2roleP2g2r'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPerson2group2roleP2g2rQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ChurchCRM\Person2group2roleP2g2r
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\Person2group2roleP2g2r The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID)) {
            $criteria->add(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID, $this->p2g2r_per_id);
        }
        if ($this->isColumnModified(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID)) {
            $criteria->add(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID, $this->p2g2r_grp_id);
        }
        if ($this->isColumnModified(Person2group2roleP2g2rTableMap::COL_P2G2R_RLE_ID)) {
            $criteria->add(Person2group2roleP2g2rTableMap::COL_P2G2R_RLE_ID, $this->p2g2r_rle_id);
        }
    ...
    {
        $criteria = ChildPerson2group2roleP2g2rQuery::create();
        $criteria->add(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID, $this->p2g2r_per_id);
        $criteria->add(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID, $this->p2g2r_grp_id);
    ...
    public function hashCode()
    {
        ...
        //relation person2group2role_p2g2r_fk_752f7c to table person_per
        ...
        //relation person2group2role_p2g2r_fk_6274d8 to table group_grp
    ...
    {
        return (null === $this->getPersonId()) && (null === $this->getGroupId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\Person2group2roleP2g2r (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\Person2group2roleP2g2r Clone of current object.
     * @throws PropelException
     */
    ...
    public function setPerson(ChildPerson $v = null)
    {
        ...
        if ($v !== null) {
            $v->addPerson2group2roleP2g2r($this);
        }
    ...
    {
        if ($this->aPerson === null && ($this->p2g2r_per_id != 0)) {
    ...
    {
        if ($this->aGroup === null && ($this->p2g2r_grp_id != 0)) {
