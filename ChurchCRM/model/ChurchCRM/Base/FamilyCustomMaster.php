...
abstract class FamilyCustomMaster implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FamilyCustomMasterTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FamilyCustomMasterTableMap::translateFieldName('Field', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_field = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FamilyCustomMasterTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FamilyCustomMasterTableMap::translateFieldName('FieldSecurity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fam_custom_fieldsec = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FamilyCustomMasterTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = FamilyCustomMasterTableMap::NUM_HYDRATE_COLUMNS.
    ...
    /**
     * Generic method to set the primary key (fam_custom_field column).
     *
