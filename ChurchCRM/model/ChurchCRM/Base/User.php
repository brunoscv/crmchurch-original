...
abstract class User implements ActiveRecordInterface
{
     ...
     * @var        string
     */
    protected $usr_twofactorauthsecret;
     ...
     * @var        int
     */
    protected $usr_twofactorauthlastkeytimestamp;
     ...
     * @var        string
     */
    protected $usr_twofactorauthrecoverycodes;
    ...
    public function setTwoFactorAuthLastKeyTimestamp($v)
    {
        ...
        return $this;
    } // setTwoFactorAuthLastKeyTimestamp()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UserTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_notes = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : UserTableMap::translateFieldName('Admin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_admin = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : UserTableMap::translateFieldName('SearchLimit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_searchlimit = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : UserTableMap::translateFieldName('Style', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_style = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : UserTableMap::translateFieldName('ShowPledges', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showpledges = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : UserTableMap::translateFieldName('ShowPayments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_showpayments = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : UserTableMap::translateFieldName('ShowSince', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_showsince = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : UserTableMap::translateFieldName('DefaultFY', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_defaultfy = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : UserTableMap::translateFieldName('CurrentDeposit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_currentdeposit = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : UserTableMap::translateFieldName('UserName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_username = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : UserTableMap::translateFieldName('ApiKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_apikey = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : UserTableMap::translateFieldName('TwoFactorAuthSecret', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_twofactorauthsecret = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : UserTableMap::translateFieldName('TwoFactorAuthLastKeyTimestamp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_twofactorauthlastkeytimestamp = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : UserTableMap::translateFieldName('TwoFactorAuthRecoveryCodes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_twofactorauthrecoverycodes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : UserTableMap::translateFieldName('EditSelf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_editself = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : UserTableMap::translateFieldName('CalStart', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calstart = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : UserTableMap::translateFieldName('CalEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calend = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : UserTableMap::translateFieldName('CalNoSchool1', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool1 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : UserTableMap::translateFieldName('CalNoSchool2', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool2 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : UserTableMap::translateFieldName('CalNoSchool3', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool3 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : UserTableMap::translateFieldName('CalNoSchool4', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool4 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : UserTableMap::translateFieldName('CalNoSchool5', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool5 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : UserTableMap::translateFieldName('CalNoSchool6', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool6 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : UserTableMap::translateFieldName('CalNoSchool7', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool7 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : UserTableMap::translateFieldName('CalNoSchool8', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->usr_calnoschool8 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : UserTableMap::translateFieldName('Searchfamily', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usr_searchfamily = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : UserTableMap::translateFieldName('Canvasser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 39; // 39 = UserTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 23:
                ...
                break;
            case 24:
                return $this->getTwoFactorAuthLastKeyTimestamp();
                break;
            case 25:
                return $this->getTwoFactorAuthRecoveryCodes();
                break;
            case 26:
                return $this->getEditSelf();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[14] => $this->getSearchLimit(),
            $keys[15] => $this->getStyle(),
            $keys[16] => $this->getShowPledges(),
            $keys[17] => $this->getShowPayments(),
            $keys[18] => $this->getShowSince(),
            $keys[19] => $this->getDefaultFY(),
            $keys[20] => $this->getCurrentDeposit(),
            $keys[21] => $this->getUserName(),
            $keys[22] => $this->getApiKey(),
            $keys[23] => $this->getTwoFactorAuthSecret(),
            $keys[24] => $this->getTwoFactorAuthLastKeyTimestamp(),
            $keys[25] => $this->getTwoFactorAuthRecoveryCodes(),
            $keys[26] => $this->getEditSelf(),
            $keys[27] => $this->getCalStart(),
            $keys[28] => $this->getCalEnd(),
            $keys[29] => $this->getCalNoSchool1(),
            $keys[30] => $this->getCalNoSchool2(),
            $keys[31] => $this->getCalNoSchool3(),
            $keys[32] => $this->getCalNoSchool4(),
            $keys[33] => $this->getCalNoSchool5(),
            $keys[34] => $this->getCalNoSchool6(),
            $keys[35] => $this->getCalNoSchool7(),
            $keys[36] => $this->getCalNoSchool8(),
            $keys[37] => $this->getSearchfamily(),
            $keys[38] => $this->getCanvasser(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[14], $arr)) {
            $this->setSearchLimit($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setStyle($arr[$keys[15]]);
        }
        if (array_key_exists($keys[16], $arr)) {
            $this->setShowPledges($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setShowPayments($arr[$keys[17]]);
        }
        if (array_key_exists($keys[18], $arr)) {
            $this->setShowSince($arr[$keys[18]]);
        }
        if (array_key_exists($keys[19], $arr)) {
            $this->setDefaultFY($arr[$keys[19]]);
        }
        if (array_key_exists($keys[20], $arr)) {
            $this->setCurrentDeposit($arr[$keys[20]]);
        }
        if (array_key_exists($keys[21], $arr)) {
            $this->setUserName($arr[$keys[21]]);
        }
        if (array_key_exists($keys[22], $arr)) {
            $this->setApiKey($arr[$keys[22]]);
        }
        if (array_key_exists($keys[23], $arr)) {
            $this->setTwoFactorAuthSecret($arr[$keys[23]]);
        }
        if (array_key_exists($keys[24], $arr)) {
            $this->setTwoFactorAuthLastKeyTimestamp($arr[$keys[24]]);
        }
        if (array_key_exists($keys[25], $arr)) {
            $this->setTwoFactorAuthRecoveryCodes($arr[$keys[25]]);
        }
        if (array_key_exists($keys[26], $arr)) {
            $this->setEditSelf($arr[$keys[26]]);
        }
        if (array_key_exists($keys[27], $arr)) {
            $this->setCalStart($arr[$keys[27]]);
        }
        if (array_key_exists($keys[28], $arr)) {
            $this->setCalEnd($arr[$keys[28]]);
        }
        if (array_key_exists($keys[29], $arr)) {
            $this->setCalNoSchool1($arr[$keys[29]]);
        }
        if (array_key_exists($keys[30], $arr)) {
            $this->setCalNoSchool2($arr[$keys[30]]);
        }
        if (array_key_exists($keys[31], $arr)) {
            $this->setCalNoSchool3($arr[$keys[31]]);
        }
        if (array_key_exists($keys[32], $arr)) {
            $this->setCalNoSchool4($arr[$keys[32]]);
        }
        if (array_key_exists($keys[33], $arr)) {
            $this->setCalNoSchool5($arr[$keys[33]]);
        }
        if (array_key_exists($keys[34], $arr)) {
            $this->setCalNoSchool6($arr[$keys[34]]);
        }
        if (array_key_exists($keys[35], $arr)) {
            $this->setCalNoSchool7($arr[$keys[35]]);
        }
        if (array_key_exists($keys[36], $arr)) {
            $this->setCalNoSchool8($arr[$keys[36]]);
        }
        if (array_key_exists($keys[37], $arr)) {
            $this->setSearchfamily($arr[$keys[37]]);
        }
        if (array_key_exists($keys[38], $arr)) {
            $this->setCanvasser($arr[$keys[38]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USR_APIKEY)) {
            $criteria->add(UserTableMap::COL_USR_APIKEY, $this->usr_apikey);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_TWOFACTORAUTHSECRET)) {
            $criteria->add(UserTableMap::COL_USR_TWOFACTORAUTHSECRET, $this->usr_twofactorauthsecret);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_TWOFACTORAUTHLASTKEYTIMESTAMP)) {
            $criteria->add(UserTableMap::COL_USR_TWOFACTORAUTHLASTKEYTIMESTAMP, $this->usr_twofactorauthlastkeytimestamp);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_TWOFACTORAUTHRECOVERYCODES)) {
            $criteria->add(UserTableMap::COL_USR_TWOFACTORAUTHRECOVERYCODES, $this->usr_twofactorauthrecoverycodes);
        }
        if ($this->isColumnModified(UserTableMap::COL_USR_EDITSELF)) {
